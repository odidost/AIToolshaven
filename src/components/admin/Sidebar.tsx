...
const cmsNavItems = [
  ...
  { label: 'Assets', href: '/admin/assets', icon: 'collections' },
  { label: 'Missing Logos', href: '/admin/assets/missing-logos', icon: 'broken_image' },
  { label: 'SEO', href: '/admin/cms/seo', icon: 'search' },
  { label: 'GSC Intelligence', href: '/admin/seo/gsc', icon: 'monitoring' },

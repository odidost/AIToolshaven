...
import { defaultGoalsFaqs, type GoalFAQItem } from "@/lib/data/goalsFaqsData";

export function GoalsFAQ({ faqs = defaultGoalsFaqs }: { faqs?: GoalFAQItem[] }) {
    ...
    <section className="mt-16 mb-20 max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-on-surface tracking-tight mb-4">
          Everything You Need to Know About Goal-Based AI Selection
        </h2>
        <p className="text-base sm:text-lg text-on-surface-variant max-w-2xl mx-auto leading-relaxed">
          Unbiased answers on monetizing AI tools, validating business models on free tiers, and execution.
        </p>
      </div>

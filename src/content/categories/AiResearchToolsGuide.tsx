...
const useCases = [
  {
    id: "phd",
    title: "PhD Candidates & Academic Researchers",
    icon: <GraduationCap className="w-5 h-5" />,
    content: "Compress literature reviews from months into days. Researchers use Consensus and Jenni AI to map out competing scientific hypotheses, extract methodologies and sample sizes across 50+ papers, and insert verified citations in APA, MLA, or IEEE format."
  },
  {
    id: "clinicians",
    title: "Clinicians & Medical Professionals",
    icon: <Briefcase className="w-5 h-5" />,
    content: "Verify treatment efficacy against randomized controlled trials (RCTs). Healthcare providers use Consensus to check scientific agreement ratios on clinical interventions, reviewing sample sizes and risk ratios in 30 seconds."
  },
  {
    id: "journalists",
    title: "Policy Analysts & Science Journalists",
    icon: <FileText className="w-5 h-5" />,
    content: "Ground public reporting in verified scientific evidence. Analysts deploy academic search engines to cross-examine political or corporate claims against peer-reviewed literature, avoiding misinformation and biased press releases."
  }
];

const glossaryTerms = [
  { term: "Digital Object Identifier (DOI)", def: "A standardized unique alphanumeric string assigned by the International DOI Foundation that permanently identifies a published academic paper." },
  { term: "Consensus Meter Metric", def: "An NLP classification algorithm that analyzes relevant study abstracts and categorizes findings as 'Yes', 'No', or 'Possibly' to quantify scientific agreement." },
  { term: "Semantic Scholar Corpus", def: "A curated graph database indexing over 200 million peer-reviewed academic papers across all scientific and humanities disciplines." },
  { term: "Randomized Controlled Trial (RCT) Tagging", def: "Automated extraction that identifies study methodologies, patient sample sizes, and double-blind controls to help evaluate evidence quality." }
];
...
const alternatives = [
  { 
    ...
    score: "9.8", 
    price: "Freemium / $9/mo", 
    bestFor: "Scientific Evidence & Consensus Meter", 
    highlight: "AI academic search engine querying 200M+ peer-reviewed papers with real DOIs and scientific agreement percentages." 
  },
  { 
    name: "Paperpal", 
    slug: "paperpal",
    ...
    bestFor: "Journal Language Polishing & MS Word", 
    highlight: "Academic grammar editor trained exclusively on published journal manuscripts with pre-submission compliance checks." 
  },
  { 
    name: "Jenni AI", 
    slug: "jenni-ai",
    ...
    bestFor: "Academic Co-Writing & Citations", 
    highlight: "Interactive academic writing assistant with sentence-level suggestions, citation auto-complete, and plagiarism checking." 
  }
];
...
export default function AiResearchToolsGuide() {
    ...
    <article className="w-full max-w-6xl mx-auto py-24 font-sans overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 px-8 py-20 md:py-32 flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            ...
            2026 Academic Rigor &amp; Scientific Synthesis Deep Dive
          </motion.div>
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-orange-400 to-amber-400 drop-shadow-sm">
              AI Academic &amp; Scientific Research
            </span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            From evidence-backed literature reviews across 200M+ peer-reviewed papers to journal-ready manuscript polishing and zero-hallucination citations: how researchers synthesize science 10x faster.
          </motion.p>
        </div>
      </motion.section>
      ...
      <motion.section variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} className="my-32 md:my-48 max-w-5xl mx-auto">
        <motion.div variants={fadeUpVariant} className="text-center mb-16">
          ...
          <h4 className="text-3xl md:text-5xl font-black text-on-surface tracking-tighter">From Hallucinated Web Claims to Verifiable Scientific Evidence</h4>
        </motion.div>
        ...
        <div className="space-y-24">
          ...
          <motion.div variants={fadeUpVariant} className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 space-y-6">
              ...
              <h5 className="text-3xl font-extrabold text-on-surface tracking-tight">The Elimination of Fabricated Academic Citations</h5>
              <p className={figtreeBodyClass}>
                Standard consumer chatbots frequently invent fictional papers, fake authors, and broken DOIs. Specialized scientific engines like <Link href="/tool/consensus" className="font-bold underline decoration-primary/40 underline-offset-4 hover:text-primary transition-colors">Consensus</Link> connect directly to the Semantic Scholar and PubMed databases of 200M+ peer-reviewed articles, providing quantifiable agreement ratios (The Consensus Meter) and real citation links.
              </p>
            </div>
               ...
               <div className="w-full max-w-xs aspect-square rounded-3xl bg-slate-900/95 border border-white/20 p-5 flex flex-col justify-between relative z-10 shadow-2xl transition-transform duration-700 group-hover:scale-105 font-mono text-xs">
                 <div className="flex items-center justify-between border-b border-white/10 pb-3">
                   <div className="flex items-center gap-2 text-rose-400 font-bold">
                     <BarChart3 className="w-4 h-4" /> Consensus Meter
                   </div>
                   <div className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300 text-xs font-bold font-sans">82% Agreement</div>
                 </div>
                 
                 <div className="space-y-2 text-slate-300 py-2">
                   <div className="text-slate-400 font-sans italic">&quot;Does creatine enhance cognitive memory in healthy adults?&quot;</div>
                   <div className="bg-slate-800 p-2.5 rounded-xl border border-white/10 text-[11px] text-slate-200 font-sans">
                     <span className="text-emerald-400 font-bold">Scientific Synthesis: </span>
                     18 RCTs analyzed • Statistically significant positive effect in working memory tasks.
                   </div>
                 </div>

                 <div className="flex justify-between items-center text-[10px] text-slate-400 border-t border-white/10 pt-2 font-mono">
                   <span>Corpus: <strong>200M+ Papers</strong></span>
                   <span className="text-success font-bold">100% Real DOIs</span>
                 </div>
               </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeUpVariant} className="grid md:grid-cols-2 gap-12 items-center">
               ...
               <div className="w-full max-w-sm space-y-4 relative z-10 transition-transform duration-700 group-hover:scale-105">
                 <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-white/20 rounded-2xl p-4 shadow-md flex items-center justify-between">
                   <div className="flex items-center gap-3">
                     ...
                     <div>
                       <div className="text-xs font-bold text-on-surface">Journal Readiness Audit</div>
                       <div className="text-[10px] text-slate-400">Paperpal MS Word Integration</div>
                     </div>
                   </div>
                   <span className="text-xs font-bold text-success px-2 py-0.5 bg-success/10 rounded-full">Nature / IEEE</span>
                 </div>
                 ...
                 <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-white/20 rounded-2xl p-4 shadow-md space-y-2">
                   <div className="flex justify-between items-center text-xs font-bold">
                     <span className="text-slate-500">In-Text Citation Auto-Complete</span>
                     <span className="text-orange-500 font-mono">Jenni AI</span>
                   </div>
                   <div className="h-14 bg-gradient-to-r from-orange-400/20 to-rose-400/20 rounded-xl border border-dashed border-rose-400/40 flex items-center justify-center text-xs font-bold text-rose-500">
                     (Smith et al., 2024, doi:10.1038/s41586)
                   </div>
                 </div>
               </div>
            </div>
            <div className="space-y-6">
              ...
              <h5 className="text-3xl font-extrabold text-on-surface tracking-tight">Journal-Ready Language Polishing &amp; Citation Integrity</h5>
              <p className={figtreeBodyClass}>
                Generic grammar checkers flag formal academic passive phrasing as &apos;wordy&apos;. Platforms like <Link href="/tool/paperpal" className="font-bold underline decoration-primary/40 underline-offset-4 hover:text-primary transition-colors">Paperpal</Link> and <Link href="/tool/jenni-ai" className="font-bold underline decoration-primary/40 underline-offset-4 hover:text-primary transition-colors">Jenni AI</Link> are trained exclusively on published journal literature, preserving formal scientific conventions and automating in-text citations in APA, MLA, and IEEE formats.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      {/* 2.5: Interactive ROI / Literature Review Calculator */}
      <motion.section 
      ...
      >
        <div className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-900 border border-slate-200 dark:border-slate-800 rounded-[3rem] p-10 md:p-16 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center mb-12">
            ...
            <h3 className="text-3xl md:text-5xl font-black text-on-surface tracking-tighter mb-4">Calculate Academic Literature Review ROI</h3>
            <p className={figtreeBodyClass + " max-w-xl"}>
              See how evidence-backed AI research assistants accelerate dissertation writing, literature synthesis, and paper submissions.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center relative z-10">
            <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700 p-8 rounded-3xl">
              ...
              <div className="text-slate-500 font-semibold mb-2">50-Paper Literature Review</div>
              <div className="text-4xl font-black text-on-surface tracking-tight">
                {roiMode === "ai" ? "2.5 Hours" : "45+ Hours"}
              </div>
            </div>
            <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700 p-8 rounded-3xl">
              <DollarSign className={`w-8 h-8 mx-auto mb-4 ${roiMode === "ai" ? "text-success" : "text-slate-400"}`} />
              <div className="text-slate-500 font-semibold mb-2">Citation Accuracy</div>
              <div className="text-4xl font-black text-on-surface tracking-tight">
                {roiMode === "ai" ? "100% Real DOIs" : "Prone to Errors"}
              </div>
            </div>
            <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700 p-8 rounded-3xl">
              <LineChart className={`w-8 h-8 mx-auto mb-4 ${roiMode === "ai" ? "text-primary" : "text-slate-400"}`} />
              <div className="text-slate-500 font-semibold mb-2">Pre-Submission Revisions</div>
              <div className="text-4xl font-black text-on-surface tracking-tight">
                {roiMode === "ai" ? "1 Pass" : "4–6 Passes"}
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col md:flex-row gap-16">
              <div className="md:w-1/2 space-y-8">
                ...
                <h3 className="text-4xl md:text-5xl font-black text-white leading-[1.1] tracking-tight">
                  Search 200M+ peer-reviewed scientific papers with <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-orange-400 to-amber-400">Consensus</span>
                </h3>
                
                <p className={figtreeDarkBodyClass}>
                  <Link href="/tool/consensus" className="text-white underline font-bold hover:text-amber-300 transition-colors">Consensus</Link> is the gold standard AI academic search engine. Query 200M+ peer-reviewed papers from Semantic Scholar, extract scientific consensus ratios with the Consensus Meter, and generate evidence-based literature syntheses with 100% verified DOIs.
                </p>

                <div className="flex flex-wrap gap-4">
                  <Link href="/tool/consensus" className="group/btn inline-flex items-center gap-3 px-8 py-4 bg-white text-slate-900 rounded-2xl font-bold text-lg hover:bg-rose-50 hover:scale-105 hover:shadow-xl transition-all duration-300">
                    Read Our Consensus Review
              ...
              <div className="md:w-1/2 flex flex-col justify-center">
                <div className="bg-slate-800/40 border border-white/5 rounded-[2rem] p-10 space-y-8 shadow-2xl backdrop-blur-sm">
                  <h4 className="text-white font-extrabold text-2xl tracking-tight">The Consensus Advantage</h4>
                  {[
                    { title: "200M+ Peer-Reviewed Papers", desc: "Direct integration with the Semantic Scholar scientific corpus." },
                    { title: "The Consensus Meter", desc: "Calculates the percentage of studies agreeing or disagreeing with hypotheses." },
                    { title: "100% Real Verifiable DOIs", desc: "Zero hallucinated citations or fake academic author claims." },
                    { title: "Study Methodology Extraction", desc: "Instant visibility into sample sizes, RCT status, and journal SJR rankings." }
                  ].map((feature, i) => (
      ...
      >
        <div className="text-center mb-12">
          ...
          <h4 className="text-3xl font-black text-on-surface tracking-tighter">Top AI Academic Research Tools</h4>
        </div>
      ...
      >
        <motion.div variants={fadeUpVariant} className="text-center mb-16">
          ...
          <h4 className="text-3xl md:text-5xl font-black text-on-surface tracking-tighter">What to Demand from Scientific AI</h4>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <motion.div variants={fadeUpVariant} className="md:col-span-2 bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-10 hover:shadow-2xl hover:border-red-500/30 hover:-translate-y-2 transition-all duration-500 group overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-3xl font-extrabold text-on-surface mb-6 tracking-tight">100% Real DOI Grounding (Zero Hallucinations)</h4>
              <p className={figtreeBodyClass}>
                Scientific integrity is non-negotiable. An academic AI must ground every statement in verified peer-reviewed publications with clickable DOIs, allowing peer reviewers and clinicians to trace claims directly back to primary sources.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeUpVariant} className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-10 hover:shadow-2xl hover:border-amber-500/30 hover:-translate-y-2 transition-all duration-500 group overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-2xl font-extrabold text-on-surface mb-4 tracking-tight">Study Quality Filters</h4>
              <p className={figtreeBodyClass}>
                Demand filtering by study design (RCT, Meta-Analysis, Systematic Review) and journal impact factor like <Link href="/tool/consensus" className="font-bold underline hover:text-primary">Consensus</Link>.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeUpVariant} className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-10 hover:shadow-2xl hover:border-orange-500/30 hover:-translate-y-2 transition-all duration-500 group overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-2xl font-extrabold text-on-surface mb-4 tracking-tight">MS Word &amp; Overleaf Add-Ins</h4>
              <p className={figtreeBodyClass}>
                Ensure the platform integrates directly with Microsoft Word and LaTeX workflows with native track changes support.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeUpVariant} className="md:col-span-2 bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-10 hover:shadow-2xl hover:border-rose-500/30 hover:-translate-y-2 transition-all duration-500 group overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-3xl font-extrabold text-on-surface mb-6 tracking-tight">Unpublished Manuscript Confidentiality</h4>
              <p className={figtreeBodyClass}>
                Protecting unreleased scientific intellectual property is paramount. Demand enterprise privacy agreements guaranteeing that your submitted research proposals, lab datasets, and unpublished drafts are never retained or used to train public models.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h4 className="text-3xl md:text-5xl font-black text-white tracking-tighter mb-16">How to Synthesize Scientific Research in 4 Steps</h4>
          
          <div className="space-y-12">
            {[
              { title: "Formulate a Falsifiable Research Query", text: "Pose precise scientific questions: 'Does high-intensity interval training (HIIT) improve mitochondrial biogenesis more than steady-state cardio?'" },
              { title: "Inspect the Scientific Consensus Meter", text: "Evaluate the percentage of published studies agreeing with the hypothesis, filtering specifically for randomized controlled trials." },
              { title: "Synthesize Literature Review Passages", text: "Use citation copilots like Jenni AI to draft discussion sections, automatically inserting verifiable citations in APA, MLA, or IEEE format." },
              { title: "Run Journal Pre-Submission Language Proofing", text: "Use Paperpal in Microsoft Word to scan for formal academic vocabulary, passive voice consistency, and publisher guideline compliance." }
            ].map((step, idx) => (

...
const useCases = [
  {
    ...
    content: "Edit 1-hour podcast episodes in 10 minutes. Creators use Descript and Riverside.fm to cut filler words automatically, generate animated karaoke captions for TikTok, and edit audio by simply deleting text from the script."
  },
  {
    id: "journalists",
    title: "Journalists & Qualitative Researchers",
    icon: <FileText className="w-5 h-5" />,
    content: "Search across hundreds of hours of field recordings instantly. Researchers upload raw WAV files into Sonix AI to generate verbatim transcripts, highlight direct quotes, and translate multi-language interviews into English with timestamps."
  },
  {
    id: "legal",
    title: "Legal & Corporate Compliance Teams",
    icon: <Briefcase className="w-5 h-5" />,
    content: "Transcribe depositions, hearings, and boardroom discussions with strict chain-of-custody compliance. Legal teams utilize enterprise speech-to-text platforms with custom jargon vocabularies and SOC 2 Type II data encryption."
  }
];

const glossaryTerms = [
  { term: "Word Error Rate (WER)", def: "The universal benchmark metric for speech recognition accuracy: (Substitutions + Deletions + Insertions) / Total Words." },
  { term: "OpenAI Whisper Architecture", def: "A state-of-the-art Transformer speech recognition model trained on 680,000+ hours of diverse multilingual audio datasets." },
  { term: "Custom Acoustic Vocabulary", def: "Training transcription engines on domain-specific medical, legal, and brand terminology to prevent phonetic misspellings." },
  { term: "Timestamped Subtitle Serialization (.SRT / .VTT)", def: "Generating timecode-synchronized caption files matching text syllables to millisecond video frames." }
];
...
const alternatives = [
  { 
    ...
    bestFor: "Text-Based Audio & Video Editing", 
  ...
  { 
    ...
    bestFor: "Studio Recording & Local Transcripts", 
  ...
  { 
    ...
    slug: "sonix-ai",
    score: "9.4", 
    price: "Pay-As-You-Go / $10/hr", 
    bestFor: "Multi-Language Translation & Subtitles", 
...
export default function AiTranscriptionToolsGuide() {
    ...
    <article className="w-full max-w-6xl mx-auto py-24 font-sans overflow-hidden">
      ...
      <motion.section variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} className="my-32 md:my-48 max-w-5xl mx-auto">
        <motion.div variants={fadeUpVariant} className="text-center mb-16">
          ...
          <h4 className="text-3xl md:text-5xl font-black text-on-surface tracking-tighter">From Slow Manual Typing to Text-Based Media Manipulation</h4>
        </motion.div>
        ...
        <div className="space-y-24">
          ...
          <motion.div variants={fadeUpVariant} className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 space-y-6">
              ...
              <h5 className="text-3xl font-extrabold text-on-surface tracking-tight">The Invention of Text-Based Audio &amp; Video Editing</h5>
              <p className={figtreeBodyClass}>
                Scrubbing back and forth on complicated timeline waveforms is tedious and slow. Pioneered by <Link href="/tool/descript" className="font-bold underline decoration-primary/40 underline-offset-4 hover:text-primary transition-colors">Descript</Link>, text-based editing transforms audio tracks into editable text documents. Delete a sentence in the script, and the software cuts the corresponding audio seamlessly, purging &apos;ums&apos; and long pauses with one click.
              </p>
            </div>
               ...
               <div className="w-full max-w-xs aspect-square rounded-3xl bg-slate-900/95 border border-white/20 p-5 flex flex-col justify-between relative z-10 shadow-2xl transition-transform duration-700 group-hover:scale-105 font-mono text-xs">
                 <div className="flex items-center justify-between border-b border-white/10 pb-3">
                   <div className="flex items-center gap-2 text-rose-400 font-bold">
                     <Scissors className="w-4 h-4" /> Text-Based Audio Slicer
                   </div>
                   <div className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300 text-xs font-bold font-sans">Purged 14 &apos;Ums&apos;</div>
                 </div>
                 
                 <div className="space-y-2 text-slate-300 py-2">
                   <div className="text-slate-400 font-sans italic">&quot;So <span className="line-through text-rose-400">um</span> our core revenue grew <span className="line-through text-rose-400">like</span> 45% YoY...&quot;</div>
                   <div className="bg-slate-800 p-2.5 rounded-xl border border-white/10 text-[11px] text-slate-200 font-sans">
                     <span className="text-emerald-400 font-bold">Descript AI: </span>
                     Audio waveform trimmed automatically with Studio Sound denoising.
                   </div>
                 </div>

                 <div className="flex justify-between items-center text-[10px] text-slate-400 border-t border-white/10 pt-2 font-mono">
                   <span>Accuracy: <strong>99.4% WER</strong></span>
                   <span className="text-success font-bold">Export Ready</span>
                 </div>
               </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeUpVariant} className="grid md:grid-cols-2 gap-12 items-center">
               ...
               <div className="w-full max-w-sm space-y-4 relative z-10 transition-transform duration-700 group-hover:scale-105">
                 <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-white/20 rounded-2xl p-4 shadow-md flex items-center justify-between">
                   <div className="flex items-center gap-3">
                     ...
                     <div>
                       <div className="text-xs font-bold text-on-surface">Local 4K Master Track</div>
                       <div className="text-[10px] text-slate-400">Riverside.fm • Separate Channels</div>
                     </div>
                   </div>
                   <span className="text-xs font-bold text-success px-2 py-0.5 bg-success/10 rounded-full">Lossless</span>
                 </div>
                 ...
                 <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-white/20 rounded-2xl p-4 shadow-md space-y-2">
                   <div className="flex justify-between items-center text-xs font-bold">
                     <span className="text-slate-500">Multi-Language Translation</span>
                     <span className="text-orange-500 font-mono">Sonix AI</span>
                   </div>
            ...
            <div className="space-y-6">
              ...
              <h5 className="text-3xl font-extrabold text-on-surface tracking-tight">Studio-Quality Recording &amp; Multi-Lingual Translation</h5>
              <p className={figtreeBodyClass}>
                Capturing clean audio is the prerequisite for flawless transcription. Platforms like <Link href="/tool/riverside-fm" className="font-bold underline decoration-primary/40 underline-offset-4 hover:text-primary transition-colors">Riverside.fm</Link> record lossless audio locally on each participant&apos;s device before internet compression, while services like <Link href="/tool/sonix-ai" className="font-bold underline decoration-primary/40 underline-offset-4 hover:text-primary transition-colors">Sonix AI</Link> translate spoken audio into 40+ languages with synchronized subtitle timestamps.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      {/* 2.5: Interactive ROI / Transcription Speed Calculator */}
      <motion.section 
      ...
      >
        <div className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-900 border border-slate-200 dark:border-slate-800 rounded-[3rem] p-10 md:p-16 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center mb-12">
            ...
            <h3 className="text-3xl md:text-5xl font-black text-on-surface tracking-tighter mb-4">Calculate Transcription Production ROI</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center relative z-10">
            <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700 p-8 rounded-3xl">
              ...
              <div className="text-slate-500 font-semibold mb-2">Turnaround / 60 Min Audio</div>
              <div className="text-4xl font-black text-on-surface tracking-tight">
                {roiMode === "ai" ? "90 Seconds" : "24–48 Hours"}
              </div>
            </div>
            <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700 p-8 rounded-3xl">
              <DollarSign className={`w-8 h-8 mx-auto mb-4 ${roiMode === "ai" ? "text-success" : "text-slate-400"}`} />
              <div className="text-slate-500 font-semibold mb-2">Cost per Audio Hour</div>
              <div className="text-4xl font-black text-on-surface tracking-tight">
                {roiMode === "ai" ? "$0.60" : "$90.00+"}
              </div>
            </div>
            <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700 p-8 rounded-3xl">
              <LineChart className={`w-8 h-8 mx-auto mb-4 ${roiMode === "ai" ? "text-primary" : "text-slate-400"}`} />
              <div className="text-slate-500 font-semibold mb-2">Transcription Accuracy</div>
              <div className="text-4xl font-black text-on-surface tracking-tight">
                {roiMode === "ai" ? "99.4% WER" : "98.5% WER"}
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col md:flex-row gap-16">
              <div className="md:w-1/2 space-y-8">
                ...
                <h3 className="text-4xl md:text-5xl font-black text-white leading-[1.1] tracking-tight">
                  Edit audio and video like a text document with <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-orange-400 to-amber-400">Descript</span>
                </h3>
                
                <p className={figtreeDarkBodyClass}>
                  <Link href="/tool/descript" className="text-white underline font-bold hover:text-amber-300 transition-colors">Descript</Link> is the all-in-one AI audio and video editor. Ingest raw recordings, generate 99%+ accurate transcripts with speaker labels, remove filler words with 1 click, and enhance audio quality instantly with Studio Sound AI.
                </p>

                <div className="flex flex-wrap gap-4">
                  <Link href="/tool/descript" className="group/btn inline-flex items-center gap-3 px-8 py-4 bg-white text-slate-900 rounded-2xl font-bold text-lg hover:bg-rose-50 hover:scale-105 hover:shadow-xl transition-all duration-300">
                    Read Our Descript Review
              ...
              <div className="md:w-1/2 flex flex-col justify-center">
                <div className="bg-slate-800/40 border border-white/5 rounded-[2rem] p-10 space-y-8 shadow-2xl backdrop-blur-sm">
                  <h4 className="text-white font-extrabold text-2xl tracking-tight">The Descript Advantage</h4>
                  {[
                    { title: "Text-Based Media Editing", desc: "Cut, copy, and paste audio and video by editing the script." },
                    { title: "1-Click Filler Word Removal", desc: "Instantly detect and delete 'ums', 'ahs', and awkward pauses." },
                    { title: "Studio Sound AI Processing", desc: "Remove room echo and background noise with regenerative neural audio." },
                    { title: "Overdub Voice Cloning", desc: "Fix spoken errors by simply typing the corrected word." }
                  ].map((feature, i) => (
      ...
      >
        <div className="text-center mb-12">
          ...
          <h4 className="text-3xl font-black text-on-surface tracking-tighter">Top AI Transcription Tools</h4>
        </div>
      ...
      >
        <motion.div variants={fadeUpVariant} className="text-center mb-16">
          ...
          <h4 className="text-3xl md:text-5xl font-black text-on-surface tracking-tighter">What to Demand from Speech-to-Text Software</h4>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <motion.div variants={fadeUpVariant} className="md:col-span-2 bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-10 hover:shadow-2xl hover:border-red-500/30 hover:-translate-y-2 transition-all duration-500 group overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-3xl font-extrabold text-on-surface mb-6 tracking-tight">Whisper Neural Engine &amp; Low Word Error Rate (WER)</h4>
              <p className={figtreeBodyClass}>
          ...
          <motion.div variants={fadeUpVariant} className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-10 hover:shadow-2xl hover:border-amber-500/30 hover:-translate-y-2 transition-all duration-500 group overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-2xl font-extrabold text-on-surface mb-4 tracking-tight">Text-Based Audio Slicing</h4>
              <p className={figtreeBodyClass}>
                Ensure you can edit audio simply by deleting words in the transcript like <Link href="/tool/descript" className="font-bold underline hover:text-primary">Descript</Link>.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeUpVariant} className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-10 hover:shadow-2xl hover:border-orange-500/30 hover:-translate-y-2 transition-all duration-500 group overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-2xl font-extrabold text-on-surface mb-4 tracking-tight">Multi-Format Subtitle Export</h4>
              <p className={figtreeBodyClass}>
          ...
          <motion.div variants={fadeUpVariant} className="md:col-span-2 bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] p-10 hover:shadow-2xl hover:border-rose-500/30 hover:-translate-y-2 transition-all duration-500 group overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-3xl font-extrabold text-on-surface mb-6 tracking-tight">Custom Industry Jargon &amp; Acoustic Vocabularies</h4>
              <p className={figtreeBodyClass}>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h4 className="text-3xl md:text-5xl font-black text-white tracking-tighter mb-16">How to Transcribe &amp; Edit Media in 4 Steps</h4>
          
          <div className="space-y-12">
            {[
              { title: "Upload Multi-Channel Audio or Video", text: "Import your WAV, MP3, or MP4 files. If available, upload separate microphone tracks for each speaker to ensure perfect diarization." },
              { title: "Input Custom Acronyms & Speaker Names", text: "Provide speaker names and add unique brand terminology into the acoustic dictionary before starting the AI engine." },
              { title: "Strip Filler Words & Polish Audio", text: "Use 1-click automated filler word removal to purge all 'ums' and 'uhs', applying neural Studio Sound to isolate voice frequencies." },
              { title: "Export Synchronized Subtitles (.SRT / .VTT)", text: "Generate timecoded subtitle files for YouTube, Premiere Pro, or Final Cut, or export clean text summaries." }
            ].map((step, idx) => (
